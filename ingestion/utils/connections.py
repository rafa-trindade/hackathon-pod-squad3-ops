...
def get_s3_client_minio():
    """
    Retorna o cliente S3 configurado para a origem (MinIO na VPS).
    """
    return boto3.client(
        "s3",
...
def get_s3_client_oci():
    """
    Retorna o cliente S3 configurado para o destino (OCI Object Storage).
    Utiliza o estilo de endereçamento 'path' para compatibilidade total.
    """
    return boto3.client(
        "s3",
